    ...
    <div className="registro-container">
      <div className="content">
        <section>
          ...
          <h1>Cadastro</h1>
          <p>Cadastre sua instituição para ter acesso ao conteúdo personalizado da plataforma Bilíngua</p>
        ...
        <form onSubmit={handleRegistro}>
          ...
          <button className="button" type="submit">Realizar Solicitação</button>
        </form>
      </div>
    </div>
  )
